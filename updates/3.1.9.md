...
- **add** `doorhashes.lua` (located on `tp_mailbox` directory folder)
- **add** `config_mailman.lua` (located on `tp_mailbox` directory folder)
- **add** `tp-client_doorlocks.lua` (located on `tp_mailbox/client` directory folder)
- **add** `tp-client_progressbars.lua` (located on `tp_mailbox/client` directory folder)
- **add** `tp-client_menu.lua` (located on `tp_mailbox/client` directory folder)
- fxmanifest.lua
