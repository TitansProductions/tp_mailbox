...
1. Fixed a weird bug issue with job telegrams section, for some jobs the telegrams would not be available to open and would say that this job does not have any telegram section.
