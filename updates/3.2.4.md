...
1. Fixed a minimap display issue when opening the birds store, the minimap would stay hidden even when the store was closed.

## Modified Files:

- client/tp-client_birds_store.lua
- fxmanifest.lua
